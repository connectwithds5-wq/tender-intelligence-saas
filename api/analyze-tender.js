...
export default async function handler(req,res){
  ...
  try{
    ...
    return res.status(200).json({tenderId:input.tenderId||null,title:input.title||"Tender",documentUrl,analysis,extractedTextLength:extractedText.length,engine:"vercel-pdf-parse",authenticated:true});
